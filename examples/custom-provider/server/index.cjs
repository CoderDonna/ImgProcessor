...
// instead of the npm version—in a real app use `require('@ImgProcessor/companion')`
const bodyParser = require('body-parser')
const session = require('express-session')
const ImgProcessor = require('@ImgProcessor/companion')
...
app.get('/', (req, res) => {
  ...
  res.send('Welcome to my ImgProcessor companion service')
})
...
// initialize ImgProcessor
const ImgProcessorOptions = {
  providerOptions: {
    drive: {
...
app.use(ImgProcessor.app(ImgProcessorOptions).app)
...
ImgProcessor.socket(app.listen(3020), ImgProcessorOptions)
