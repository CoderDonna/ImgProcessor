...
// https://ImgProcessor.io/docs/golden-retriever/
...
self.addEventListener('install', (event) => {
  console.log('Installing ImgProcessor Service Worker...')
