...
```bash
corepack yarn workspace @ImgProcessor-example/aws-php exec "composer update"
```
...
```bash
corepack yarn workspace @ImgProcessor-example/aws-php start
```
